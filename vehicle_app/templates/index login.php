...
<html lang="en">
    ...
    <body>
        ...
        <section class="imgcar">
            ...
            <div class="rc_rcSearch">
                ...
                <div class="rc_rcSearchInput">
                    ...
                    <form method = "POST" action="vehiclesearch.php"  class="rc_vehicleForm">
        ...
        <form method="POST" action="process.php" enctype="multipart/form-data">
            <label for="vehicleImage">Select an image:</label>
            <input type="file" name="vehicleImage" id="vehicleImage" accept="image/*" required>
